-- Insert experiences from experiences.txt into experiences table
-- Comprehensive script for 3 experience entries

-- Experience 1: THE ASIAN NARRATIVE: THE PATH TO PEACE
INSERT INTO experiences (
    id, title, featured_media, taglines, country, city, region, best_time, carousel_media, brief_description, content, tags, gallery, story, duration, price, created_at, updated_at
) VALUES (
    UUID(),
    'THE ASIAN NARRATIVE: THE PATH TO PEACE',
    'https://res.cloudinary.com/dm59i8qed/image/upload/v1757648936/pexels-clement-proust-363898785-15603692_cwa8ci.jpg',
    JSON_ARRAY('A transformative journey combining Bhutan\'s spiritual awakening with Rajasthan\'s cultural grandeur.'),
    'India, Bhutan',
    'Rajasthan',
    'Asia',
    JSON_ARRAY(
        JSON_OBJECT('from', 'October', 'to', 'March')
    ),
    JSON_ARRAY(
        'https://res.cloudinary.com/dm59i8qed/image/upload/v1757648936/pexels-clement-proust-363898785-15603692_cwa8ci.jpg',
    ...
    JSON_ARRAY(
        JSON_OBJECT('title', 'Your Sanctuaries', 'content', 'Your sanctuaries for this journey are as exceptional as the landscapes themselves. In Bhutan, Amankora\'s series of lodges weave seamlessly into remote valleys, offering understated luxury amidst dramatic Himalayan peaks. Each lodge is a retreat into silence, designed for reflection, with guided treks, temple visits, and traditional Bhutanese rituals enriching your stay. In Rajasthan, Six Senses Fort Barwara welcomes you into a meticulously restored 14th-century fortress. Once the seat of royalty, today it is reimagined as a palace of wellness. Stone ramparts, candlelit courtyards, and Ayurvedic therapy rooms create a regal backdrop where history and holistic living converge.')
    ),
    JSON_ARRAY('spiritual', 'luxury', 'wellness', 'cultural', 'transformation'),
    JSON_ARRAY(
        JSON_OBJECT('name', 'Buddha Park', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758684524/cdaf9fd0-92ef-4331-b18a-2e217f07a797.png'),
        JSON_OBJECT('name', 'Monastery, Bhutan', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758684524/cdaf9fd0-92ef-4331-b18a-2e217f07a797.png'),
        JSON_OBJECT('name', 'Cultural Heritage, Bhutan', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758685309/73f64103-4182-49c2-85af-f34a5a19cb84.png'),
        JSON_OBJECT('name', 'Hawa Mahal, Jaipur', 'image', 'https://plus.unsplash.com/premium_photo-1661952578770-79010299a9f9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Ymh1dGFufGVufDB8fDB8fHww?ixlib=rb-4.0.3&auto=format&fit=crop&w=2980&q=80'),
        JSON_OBJECT('name', 'Bahubali Hills, Udaipur, Rajasthan', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758685582/f2330cf5-8dae-499a-8f26-983cc1bee5c6.png')
    ),
...
-- Experience 2: ART OF REFINEMENT
INSERT INTO experiences (
    id, title, featured_media, taglines, country, city, region, best_time, carousel_media, brief_description, content, tags, gallery, story, duration, price, created_at, updated_at
) VALUES (
    UUID(),
    ...
    JSON_ARRAY('Where culture, cuisine, and classic elegance converge'),
    'France, Austria',
    'Paris, Austrian Alps',
    'Europe',
    JSON_ARRAY(
        JSON_OBJECT('from', 'April', 'to', 'June'),
        JSON_OBJECT('from', 'September', 'to', 'December')
    ),
    JSON_ARRAY(
        'https://images.pexels.com/photos/3756718/pexels-photo-3756718.jpeg?ixlib=rb-4.0.3&auto=format&fit=crop&w=2980&q=80',
        'https://res.cloudinary.com/dm59i8qed/image/upload/v1757648928/pexels-srinivaspyata-21915040_gxhdot.jpg',
    ...
    JSON_ARRAY(
        JSON_OBJECT('title', 'Your Sanctuaries', 'content', 'Your story unfolds within two of Europe\'s most exquisite sanctuaries. In Paris, Le Royal Monceau – Raffles Paris stands as a living gallery and cultural epicenter. Its walls, adorned with contemporary masterpieces, and its Michelin-starred dining halls make it a beacon for art, gastronomy, and Parisian chic. Every corridor, every room, carries the pulse of a city defined by creativity and romance. In the Austrian Alps, an Oetker Collection Masterpiece Hotel awaits — a jewel of refined alpine luxury. Here, architecture harmonizes with dramatic peaks, offering both serenity and spectacle. Private mountain guides, world-class spas, and legendary wine cellars ensure every moment feels curated, while the surrounding landscapes remind you of nature\'s enduring artistry.')
    ),
    JSON_ARRAY('luxury', 'culture', 'cuisine', 'art', 'elegance', 'alpine'),
    JSON_ARRAY(
        JSON_OBJECT('name', 'Eiffel Tower, Paris', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758685908/31d91cb1-c003-40ac-b57b-ddc0326d3f31.png'),
        JSON_OBJECT('name', 'Louvre Museum, Paris', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758686076/ab403a05-bca1-436a-ba28-dd33ae7b5ab5.png'),
        JSON_OBJECT('name', 'Notre Dame, Paris', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758686159/b79a2880-ecf1-41ab-9dcd-e3130d3060b0.png'),
        JSON_OBJECT('name', 'Austrian Alps, Austria', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758686239/a2b43ed5-3b32-4b69-9380-4451fd74d09d.png'),
        JSON_OBJECT('name', 'Eastern Alps, Austria', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758686273/6d389d17-bb5a-4159-a200-5310f8bc0322.png')
    ),
...
-- Experience 3: THE COSTA RICAN VOLCANIC RETREAT: EDEN'S ECHO
INSERT INTO experiences (
    id, title, featured_media, taglines, country, city, region, best_time, carousel_media, brief_description, content, tags, gallery, story, duration, price, created_at, updated_at
) VALUES (
    UUID(),
    'THE COSTA RICAN VOLCANIC RETREAT: EDEN\'S ECHO',
    'https://res.cloudinary.com/dm59i8qed/image/upload/v1758687461/be9a447a-c7f4-4735-9252-9afd7bad4972.png',
    JSON_ARRAY('Rejuvenate in the warm, healing embrace of a volcanic paradise'),
    'Costa Rica',
    'Monteverde',
    'Central America',
    JSON_ARRAY(
        JSON_OBJECT('from', 'January', 'to', 'April'),
        JSON_OBJECT('from', 'December', 'to', 'December')
    ),
    JSON_ARRAY(
        'https://res.cloudinary.com/dm59i8qed/image/upload/v1758688113/a2c895fa-459f-4afc-ad5f-7dadd9ee11c3.png',
    ...
    JSON_ARRAY(
        JSON_OBJECT('title', 'Your Sanctuaries', 'content', 'Your narrative begins at the foot of the iconic Arenal Volcano, where Tabacon Thermal Resort & Spa becomes your sanctuary. Here, luxury does not compete with the rainforest — it breathes with it. A natural river of volcanic thermal springs flows through the resort, creating secluded lagoons and cascading waterfalls, each pool a hidden haven of warmth, wrapped in tropical greenery.')
    ),
    JSON_ARRAY('volcanic', 'wellness', 'nature', 'rainforest', 'thermal springs', 'eco-luxury'),
    JSON_ARRAY(
        JSON_OBJECT('name', 'Way to Arenal Volcano', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758687381/9526d0fb-b46c-408b-b0b1-92d97b99aef2.png'),
        JSON_OBJECT('name', 'Manuel Antonio Beach', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758688185/617615d4-90a7-4ccc-87be-8dccb58d77ec.png'),
        JSON_OBJECT('name', 'Arenal Volcano (Erupted)', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758687531/542f66eb-8e1a-4454-82ce-430d453a3b09.png'),
        JSON_OBJECT('name', 'Monteverde Cloud Forest', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758688166/91b75865-74a9-45d1-83c4-e6a5ed09ba62.png'),
        JSON_OBJECT('name', 'Tabacon Thermal Resort & Spa', 'image', 'https://res.cloudinary.com/dm59i8qed/image/upload/v1758686239/a2b43ed5-3b32-4b69-9380-4451fd74d09d.png')
    ),
